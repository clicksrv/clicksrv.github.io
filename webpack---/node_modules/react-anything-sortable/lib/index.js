(function webpackUniversalModuleDefinition(root, factory) {
    ...
    ([
        ...
        function(module, exports, __webpack_require__) {
            ...
            var _SortableItemMixin = __webpack_require__(20);
            ...
            var Sortable = _createReactClass2['default']({
                ...
                handleMouseDown: function handleMouseDown(e, index) {
                    ...
                    if (_utils.isFunction(this.props.onSortStart)) {
                ...
                handleMouseUp: function handleMouseUp() {
                    ...
                    if (_utils.isFunction(this.props.onSortEnd)) {
            ...
            (function(process) {
                ...
                function factory(ReactComponent, isValidElement, ReactNoopUpdateQueue) {
                    ...
                    function mixSpecIntoComponent(Constructor, spec) {
                        ...
                        _invariant(!isValidElement(spec),
                            "ReactClass: You're attempting to " +
                    ...
                    function createClass(spec) {
                        ...
                        if (process.env.NODE_ENV !== 'production') {
                            ...
                            warning(!Constructor.prototype.componentWillRecieveProps,
                                '%s has a method called ' +
                                'componentWillRecieveProps(). Did you mean componentWillReceiveProps()?',
                                spec.displayName || 'A component'
                            );
                            warning(!Constructor.prototype.UNSAFE_componentWillRecieveProps,
