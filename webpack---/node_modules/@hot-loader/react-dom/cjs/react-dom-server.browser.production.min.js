...
function ab(a, b, c) {
    function d(d, h) {
        ...
        } else if (P = {}, e = h(d.props,
                f, n), e = Da(h, d.props, e, f), null == e || null == e.render) {
            a = e;
            $a(a, h);
            return
        }
...
var bb = function() {
    ...
    b.renderDOM = function(a, b, f) {
        ...
        for (w in g)
            if (Ya.call(g, w)) {
                ...
                if (null != n) {
                    ...
                    k = null;
                    C ? Za.hasOwnProperty(w) ||
                        (k = w, k = sa(k) && null != n ? k + '="' + (O(n) + '"') : "") : k = ya(w, n);
                    k && (G += " " + k)
                }
            }
        ...
        var w = G;
        g = "";
        Na.hasOwnProperty(c) ? w += "/>" : (w += ">", g = "</" + a.type + ">");
        a: {
        ...
        a = a.type;
        f = null == f || "http://www.w3.org/1999/xhtml" === f ? Ma(a) : "http://www.w3.org/2000/svg" ===
            f && "foreignObject" === a ? "http://www.w3.org/1999/xhtml" : f;
        this.stack.push({
            domNamespace: f,
            type: c,
            children: d,
