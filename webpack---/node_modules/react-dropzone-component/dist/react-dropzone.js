! function(e, t) {
    ...
    return function(e) {
            ...
            c = t.DropzoneComponent = function(e) {
                ...
                return function(e, t) {
                    ...
                    value: function() {
                        ...
                        if (n.showFiletypeIcon && n.iconFiletypes && (!t || t.length < 1))
                            ...
                            for (var n in t)
                                if (t.hasOwnProperty(n) && t[n])
                                    if ("[object Array]" === Object.prototype.toString.call(t[n]))
                                        for (var i = 0; i < t[n].length; i += 1) "init" === n ? t[n][i](this.dropzone) : this.dropzone.on(n, t[n][i]);
        ...
        e.exports = function e() {
            var t, n, i, r, a, l, u = arguments[0],
                c = 1,
                d = arguments.length,
                p = !1;
            for ("boolean" == typeof u && (p = u, u = arguments[1] || {}, c = 2), (null == u || "object" != typeof u && "function" != typeof u) && (u = {}); c < d; ++c)
                if (null != (t = arguments[c]))
                    for (n in t) i = u[n], u !== (r = t[n]) && (p && r && (s(r) || (a = o(r))) ? (a ? (a = !1, l = i && o(i) ? i : []) : l = i && s(i) ? i : {}, u[n] = e(p, l, r)) : void 0 !== r && (u[n] = r));
            return u
        }
    }, function(e, t, n) {
        "use strict";
        ...
        (function(e) {
            ...
            var i = function() {
                    ...
                    return i(e, [{
                        ...
                        value: function(e) {
                            ...
                            if (t) {
                                ...
                                for (var o = 0, s = s = t; !(o >= s.length);) s[o++].apply(this, i)
                            }
                            return this
                        }
                    }, {
                ...
                o = function(e) {
                    function o(e, i) {
                        n(this, o);
                        var r, s = t(this, (o.__proto__ || Object.getPrototypeOf(o)).call(this)),
                            a = void 0;
                    ...
                    return function(e, t) {
                            ...
                            this.prototype.Emitter = r, this.prototype.events = ["drop", "dragstart", "dragend", "dragenter", "dragover", "dragleave", "addedfile", "addedfiles", "removedfile", "thumbnail", "error", "errormultiple", "processing", "processingmultiple", "uploadprogress", "totaluploadprogress", "sending", "sendingmultiple", "success", "successmultiple", "canceled", "canceledmultiple", "complete", "completemultiple", "reset", "maxfilesexceeded", "maxfilesreached", "queuecomplete"], this.prototype.defaultOptions = {
                                ...
                                error: function(e, t) {
                                    if (e.previewElement) {
                                        ...
                                        for (var n = 0, i = i = e.previewElement.querySelectorAll("[data-dz-errormessage]"); !(n >= i.length);) i[n++].textContent = t
                                    }
                                },
                                ...
                                uploadprogress: function(e, t, n) {
                                    if (e.previewElement)
                                        for (var i = 0, r = r = e.previewElement.querySelectorAll("[data-dz-uploadprogress]"); !(i >= r.length);) {
                                            var o = r[i++];
                        ...
                        value: function(e) {
                            if (e.status === o.UPLOADING) {
                                for (var t = this._getFilesWithXhr(e.xhr), n = 0, i = i = t; !(n >= i.length);) i[n++].status = o.CANCELED;
                            ...
                            this._transformFiles(e, function(n) {
                                if (e[0].upload.chunked) {
                                    ...
                                    if (i.upload.finishedChunkUpload = function(n) {
                                        ...
                                        for (var a = 0; a < i.upload.totalChunkCount; a++) s();
                                    else s()
                                } else {
                        ...
                        key: "_uploadData",
                        value: function(e, t) {
                            for (var n = this, i = new XMLHttpRequest, r = 0, s = s = e; !(r >= s.length);) s[r++].xhr = i;
                        ...
                        key: "_transformFiles",
                        value: function(e, t) {
                            for (var n = this, i = [], r = 0, o = 0; o < e.length; o++) ! function(o) {
                        ...
                        value: function(e) {
                            if ("FORM" === this.element.tagName)
                                for (var t = 0, n = n = this.element.querySelectorAll("input, textarea, select, button"); !(t >= n.length);) {
                                    var i = n[t++],
                                    ...
                                    if (o && (o = o.toLowerCase()), void 0 !== r && null !== r)
                                        if ("SELECT" === i.tagName && i.hasAttribute("multiple"))
                                            for (var s = 0, a = a = i.options; !(s >= a.length);) {
                                                var l = a[s++];
                        ...
                        value: function(e, t, n) {
                            if (e[0].status !== o.CANCELED) {
                                ...
                                for (var r = 0, s = s = e; !(r >= s.length);) s[r++], this._errorProcessing(e, n || this.options.dictResponseError.replace("{{statusCode}}", t.status), t)
                            }
                        }
                    }, {
                        key: "submitRequest",
            ...
            o.initClass(), o.version = "5.4.0", o.options = {}, o.optionsForElement = function(e) {
                ...
                if (window.File && window.FileReader && window.FileList && window.Blob && window.FormData && document.querySelector)
                    if ("classList" in document.createElement("a"))
                        for (var t = 0, n = n = o.blacklistedBrowsers; !(t >= n.length);) n[t++].test(navigator.userAgent) && (e = !1);
                    else e = !1;
                else e = !1;
                return e
            ...
            var l = function(e, t, n, i, r, o, s, a, l, u) {
                    var c = function(e) {
                        e.naturalWidth;
                    ...
                    return e.drawImage(t, n, i, r, o, s, a, l, u / c)
                },
                u = function() {
                    function e() {
                        n(this, e)
