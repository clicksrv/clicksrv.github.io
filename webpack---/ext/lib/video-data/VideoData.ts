...
class VideoData {
    constructor(video, settings, pageInfo) {
        ...
        this.videoDimensionsLoaded = false;
        this.paused = false;
        this.mutationObserverConf = {
            attributes: true,
    ...
    async onVideoLoaded() {
        ...
        if (!this.videoLoaded) {
             ...
             */
            if (!((_a = this.video) === null || _a === void 0 ? void 0 : _a.videoWidth) || !((_b = this.video) === null || _b === void 0 ? void 0 : _b.videoHeight) || this.video.readyState < 2) {
    ...
    async setupStageTwo() {
        ...
        try {
            if (BrowserDetect.firefox) {
                this.observer = new ResizeObserver(_.debounce(this.onVideoDimensionsChanged, 250, {
                    leading: true,
                    trailing: true
                }));
            }
                ...
                this.observer = new ResizeObserver(_.debounce((m, o) => {
    ...
    setupMutationObserver() {
        try {
            if (BrowserDetect.firefox) {
                this.mutationObserver = new MutationObserver(_.debounce(this.onVideoMutation, 250, {
                    leading: true,
                    trailing: true
                }));
            }
                ...
                // Chrome for some reason insists that this.onPlayerDimensionsChanged is not a function
                // when it's not wrapped into an anonymous function
                this.mutationObserver = new MutationObserver(_.debounce((m, o) => {
    ...
    onVideoMutation(mutationList, observer) {
     ...
     */
    processDimensionsChanged() {
        _.debounce(this._processDimensionsChanged, 250, {
            leading: true,
            trailing: true
        });
    }
    ...
    getHeightCompensationFactor() {
        var _a;
        const heightStyle = (_a = this.getVideoStyle()) === null || _a === void 0 ? void 0 : _a.height;
    ...
    checkVideoSizeChange() {
        ...
        if (this.logger.canLog('debug')) {
            ...
            if (this.video &&
                (((_a = this.dimensions) === null || _a === void 0 ? void 0 : _a.width) != videoWidth ||
                    ((_b = this.dimensions) === null || _b === void 0 ? void 0 : _b.height) != videoHeight)) {
        ...
        if (((_c = this.dimensions) === null || _c === void 0 ? void 0 : _c.width) != videoWidth
            || ((_d = this.dimensions) === null || _d === void 0 ? void 0 : _d.height) != videoHeight) {
            this.dimensions = {
                width: videoWidth,
                height: videoHeight,
            };
