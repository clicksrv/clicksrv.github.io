...
export var CropStrategy;
(function (CropStrategy) {
    /**
     ...
     */
    CropStrategy[CropStrategy["CropLetterbox"] = 1] = "CropLetterbox";
    CropStrategy[CropStrategy["NoCropPillarbox"] = 2] = "NoCropPillarbox";
    CropStrategy[CropStrategy["NoCropLetterbox"] = 3] = "NoCropLetterbox";
    CropStrategy[CropStrategy["CropPillarbox"] = 4] = "CropPillarbox";
