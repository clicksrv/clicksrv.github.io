...
import Scaler, { CropStrategy } from './Scaler';
...
class Resizer {
    ...
    async setAr(ar, lastAr) {
        ...
        if ((ar.type !== AspectRatioType.Fixed && ar.type !== AspectRatioType.Manual) // anything not these two _always_ changes AR
        ...
        if (ar.type !== AspectRatioType.Automatic || this.stretcher.mode === StretchType.Basic) {
            (_b = (_a = this.conf) === null || _a === void 0 ? void 0 : _a.arDetector) === null || _b === void 0 ? void 0 : _b.pause();
        }
        else {
            if (this.lastAr.type === AspectRatioType.Automatic) {
                (_d = (_c = this.conf) === null || _c === void 0 ? void 0 : _c.arDetector) === null || _d === void 0 ? void 0 : _d.unpause();
            }
        }
        // do stretch thingy
        if (this.stretcher.mode === StretchType.NoStretch
            ...
            if (!stretchFactors || stretchFactors.error) {
                this.logger.log('error', 'debug', `[Resizer::setAr] <rid:${this.resizerId}> failed to set AR due to problem with calculating crop. Error:`, stretchFactors === null || stretchFactors === void 0 ? void 0 : stretchFactors.error);
                if ((stretchFactors === null || stretchFactors === void 0 ? void 0 : stretchFactors.error) === 'no_video') {
                    this.conf.destroy();
                    return;
                }
                ...
                if ((stretchFactors === null || stretchFactors === void 0 ? void 0 : stretchFactors.error) === 'illegal_video_dimensions') {
            ...
            this.logger.log('info', 'debug', "[Resizer::setAr] Processed stretch factors for ", this.stretcher.mode === StretchType.NoStretch ? 'stretch-free crop.' :
                this.stretcher.mode === StretchType.Conditional ? 'crop with conditional StretchType.' : 'crop with fixed stretch', 'Stretch factors are:', stretchFactors);
        }
    ...
    restore() {
        ...
        if (this.lastAr.type === AspectRatioType.Initial) {
            ...
            if (((_a = this.lastAr) === null || _a === void 0 ? void 0 : _a.ratio) === null) {
    ...
    reset() {
        var _a, _b;
        this.setStretchMode((_b = (_a = this.settings.active.sites[window.location.hostname]) === null || _a === void 0 ? void 0 : _a.stretch) !== null && _b !== void 0 ? _b : this.settings.active.sites['@global'].stretch);
        this.zoom.setZoom(1);
        this.resetPan();
        this.setAr({ type: AspectRatioType.Reset });
    }
     ...
     */
    computeAutoHeightCompensationFactor(realVideoWidth, realVideoHeight, playerWidth, playerHeight, mode) {
    ...
    computeOffsets(stretchFactors) {
        ...
        if ((this.conf.video.offsetWidth > this.conf.player.dimensions.width && this.conf.video.offsetHeight > this.conf.player.dimensions.height) ||
