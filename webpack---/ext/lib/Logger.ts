...
class Logger {
    ...
    storageChangeListener(changes, area) {
        ...
        // to an action.
        console.info('[uwLogger] logger config changed! New configuration:', this.conf, '\nraw changes:', changes, 'area?', area, '\n————————————————————————————————————————————————————————————————————————\n\n\n\n\n\n\n\n\n\n\n\n-----\nLogging with new settings starts now.');
    ...
    canLogFile(component) {
        var _a, _b;
        if (!((_b = (_a = this.conf) === null || _a === void 0 ? void 0 : _a.fileOptions) === null || _b === void 0 ? void 0 : _b.enabled) || this.temp_disable) {
            return false;
        }
