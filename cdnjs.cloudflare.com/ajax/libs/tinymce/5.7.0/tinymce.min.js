    ...
    var Jf = function(e, t) {
        ...
        nd = function(r, l) {
            var f, d, m, p, c, g, h, v, y, b, C, w, x, S, N, E = "data-mce-selected",
                ...
                I = function(e) {
                    return k.is(e, "figure.image") ? e.querySelector("img") : k.hasClass(e, "mce-preview-object") && V(e.firstElementChild) ? e.firstElementChild : e
                },
                M = function(e) {
                    var t = yc(l);
                ...
                z = function() {
                    ...
                    var t, n, r, o, i, a = function(e, t) {
                        var n;
                        t && ((n = I(f)).style[e] || !l.schema.isValid(n.nodeName.toLowerCase(), e) ? k.setStyle(n, e, t) : k.setAttrib(n, e, "" + t))
                    };
                    e && (a("width", w), a("height", x)), k.unbind(A, "mousemove", U), k.unbind(A, "mouseup", z), R !== A && (k.unbind(R, "mousemove", U), k.unbind(R, "mouseup", z)), k.remove(d), k.remove(m), k.remove(c), u(f), e && (t = l, n = f, r = w, o = x, i = "corner-" + p.name, t.fire("ObjectResized", {
                        target: n,
                        width: r,
                        height: o,
                        origin: i
                ...
                u = function(e) {
                    ...
                    var r = l.fire("ObjectSelected", {
                        ...
                        s = k.getAttrib(f, E, "1");
                    M(e) && !r.isDefaultPrevented() ? _(B, function(n, r) {
                        var t = function(e) {
                                var t;
                                g = e.screenX, h = e.screenY, v = I(f).clientWidth, y = I(f).clientHeight, b = y / v, (p = n).name = r, p.startPos = {
                                    x: a * n[0] + o,
                                    y: u * n[1] + i
                                    ...
                                    top: i,
                                    margin: 0
                                }), F(d, a, u), d.removeAttribute(E), O.appendChild(d), k.bind(A, "mousemove", U), k.bind(A, "mouseup", z), R !== A && (k.bind(R, "mousemove", U), k.bind(R, "mouseup", z)), m = k.add(O, "div", {
                                    "class": "mce-resize-helper",
                                    "data-mce-bogus": "all"
                                }, v + " &times; " + y)
                            },
                            e = k.get("mceResizeHandle" + r);
                        ...
                        }), n.elm = e, k.setStyles(e, {
                            left: a * n[0] + o - e.offsetWidth / 2,
                            top: u * n[1] + i - e.offsetHeight / 2
                        })
                    }) : j(), k.getAttrib(f, E) || f.setAttribute(E, s)
                },
                j = function() {
                ...
                o = function(e) {
                    ...
                    C || l.removed || (_(k.select("img[data-mce-selected],hr[data-mce-selected]"), function(e) {
                        e.removeAttribute(E)
                    }), t = "mousedown" === e.type ? e.target : r.getNode(), n(t = k.$(t).closest("table,img,figure.image,hr,video,span.mce-preview-object")[0], O) && (a(), n(r.getStart(!0), t) && n(r.getEnd(!0), t)) ? u(t) : j())
                },
                i = function(e) {
            ...
            l.on("init", function() {
                var e;
                a(), (xt.browser.isIE() || xt.browser.isEdge()) && (l.on("mousedown click", function(e) {
                    var t = e.target,
                        n = t.nodeName;
    ...
    var Tm = function(e, t) {
        ...
        Pm = function(W, K) {
            ...
            var X = W.comment ? W.comment : te,
                ...
                n = function(f, e) {
                    void 0 === e && (e = "html");
                    for (var t, i, n, d, r, o, a, m, u, s, c, l, p, g, h, v, y, b, C, w = f.html, x = 0, S = [], N = 0, E = li.decode, k = _t.makeMap("src,href,data,background,formaction,poster,xlink:href"), _ = /((java|vb)script|mhtml):/i, A = "html" === e ? 0 : 1, R = function(e) {
